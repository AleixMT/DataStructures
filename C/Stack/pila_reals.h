...
#ifndef LINEALDATASTRUCTURES_PILA_REALS_H
#define LINEALDATASTRUCTURES_PILA_REALS_H
...
#include <math.h>  // per a fer servir operacions matematiques complexes (raons trigonometriques, nombres irracionals, etc)
